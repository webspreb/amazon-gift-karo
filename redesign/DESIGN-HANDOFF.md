# af07a541-4863-4bb9-b5df-b93217887bf4 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `404.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- A single self-contained `404.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `404.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `giftkaro-prd.md`
- `plan.md`
- `plugin-source/giftkaro-curated-gift-platform-design-brief-implementation-plan-ms0p95td/open-design.json`
- `plugin-source/giftkaro-curated-gift-platform-design-brief-implementation-plan-ms0p95td/references/provenance.json`
- `plugin-source/giftkaro-curated-gift-platform-design-brief-implementation-plan-ms0p95td/references/source-1-giftkaro-prd.md`
- `plugin-source/giftkaro-curated-gift-platform-design-brief-implementation-plan-ms0p95td/SKILL.md`

## Coding checklist for AI tools
1. Inspect `404.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
